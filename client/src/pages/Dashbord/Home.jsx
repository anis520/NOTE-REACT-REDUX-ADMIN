...
<>
<p className='text-3xl font-semibold text-zinc-600 mb-4'>Welcome to deshbord</p>
   ...
   <div className="card hover:bg-green-400 group group-hover:text-white duration-300 cursor-pointer">
     <div className="card-body">
       ...
       <div className="dash-widget-info">
         <h6 className="text-zinc-800 font-semibold mt-4 group-hover:text-white">Salse</h6>
